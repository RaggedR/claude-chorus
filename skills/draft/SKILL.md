...
Create a scratch file at `.claude/scratch/draft-{timestamp}.md` (create the directory if needed). This is your **thinking medium**, not your output. Treat it like a messy notebook, not a deliverable.
