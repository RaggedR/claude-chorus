...
At generation~30, DAG families ($\kappa = 0$) retain the highest
diversity---cycles accelerate early mixing, burning through variation faster.
By generation~100, the pattern inverts: high-$\kappa$ families sustain
residual diversity through feedback loops, while DAGs converge to fixation
fastest. Ring-skip2 ($\kappa = 47$) sustains diversity longest. The
bidirectional ring does not fall monotonically, suggesting cycle
...
\begin{figure}[t]
  ...
  (30 seeds each). Cycles accelerate early diversity loss; DAGs converge to
  fixation fastest overall. Ring-skip2 ($\kappa = 47$) sustains diversity
  longest.}
